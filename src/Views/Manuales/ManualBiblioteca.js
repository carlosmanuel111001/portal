...
import data from '../About/ManualBiblioteca.json'; // Asegúrate de tener la ruta correcta al archivo JSON
import styles from './ManualBiblioteca.module.css';

function ManualBiblioteca() {
  const [manual, setManual] = useState(null);

  useEffect(() => {
    console.log(data.manuales); // Agrega esta línea para verificar el contenido
    const manualBiblioteca = data.manuales.find((m) => m.id === 'biblioteca');
    setManual(manualBiblioteca);
  }, []);
...
export default ManualBiblioteca;
